...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val about = "A Todo List app is a powerful tool that helps users stay organized and productive by allowing them to create lists of tasks that need to be completed. " +
                "With a Todo List app, users can easily add new tasks, " +
                ...
                "\n" +
                "One of the key benefits of using a Todo List app is that it can help users stay focused and on track with their goals. " +
                ...
                "\n" +
                "Another benefit of using a Todo List app is that it can help users reduce stress and anxiety by providing a sense of control and accomplishment. " +
                ...
                "\n" +
                "Overall, a Todo List app is a valuable tool for anyone who wants to stay organized and productive. With a range of features and customization options, " +
